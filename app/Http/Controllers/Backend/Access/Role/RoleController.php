...
namespace Unicorn\Http\Controllers\Backend\Access\Role;

use Unicorn\Http\Controllers\Controller;
use Unicorn\Repositories\Backend\Access\Role\RoleRepositoryContract;
use Unicorn\Http\Requests\Backend\Access\Role\EditRoleRequest;
use Unicorn\Http\Requests\Backend\Access\Role\StoreRoleRequest;
use Unicorn\Http\Requests\Backend\Access\Role\CreateRoleRequest;
use Unicorn\Http\Requests\Backend\Access\Role\DeleteRoleRequest;
use Unicorn\Http\Requests\Backend\Access\Role\UpdateRoleRequest;
